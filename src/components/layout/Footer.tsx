    ...
    return (
        <footer className="bg-[#0c1222] text-white/90 py-12 md:py-14">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                {/* Mobile: centered logo, then 2 cols (Quick Links | Categories), then Contact. Desktop: 4 cols */}
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-10 pb-10">
                    {/* Column 1: Logo, description, social — centered on mobile, left on desktop */}
                    <div className="flex flex-col gap-4 items-center text-center lg:items-start lg:text-left">
                        ...
                        <p className="text-sm text-white/80 leading-relaxed max-w-sm lg:max-w-none">
                    ...
                    {/* Mobile: 2 columns (Quick Links | Categories). Desktop: part of 4-col grid */}
                    <div className="grid grid-cols-2 gap-8 lg:contents">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-3 text-sm text-white/90">
                                <a href="/products?category=Cement" className="hover:text-white transition-colors">Cement</a>
                                <a href="/products?category=CPVC%20%2F%20PVC" className="hover:text-white transition-colors">CPVC / PVC</a>
                                <a href="/products?category=Granite%20%2F%20Marble" className="hover:text-white transition-colors">Granite / Marble</a>
                                <a href="/products?category=Floor%20Tile" className="hover:text-white transition-colors">Floor Tile</a>
                                <a href="/products?category=Wall%20%2F%20Floor%20Tile" className="hover:text-white transition-colors">Wall / Floor Tile</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border-t border-white/15 pt-8 text-center text-sm text-white/60">
                    <p>&copy; {new Date().getFullYear()} Inara Tech and Netreshwori Enterprises. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
